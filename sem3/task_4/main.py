...
from sem3.task_4.models import db, User
from flask_wtf.csrf import CSRFProtect
from secrets import token_hex
from sem3.task_4.forms import RegistrationForm, LoginForm

app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///sem3_task4.sqlite'
